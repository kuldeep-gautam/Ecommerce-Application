...
import categoryDesc from "../catDesc/catDesc.json"
...
const CategoryProduct = () => {
    ...
    return (
        <Layout>
            <img src={`/images1/${params.slug}.webp`} alt="" className="w-100" height={'300px'} style={{ marginTop: '73px' }} />
            <div className="container mt-3">
                <h4 className="text-center">{category?.name}</h4>
                <p>{categoryDesc[params.slug]}</p>
